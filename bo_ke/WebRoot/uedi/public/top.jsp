...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">伟大新闻信息管理平台</b> <!-- <img border="0" src="style/images/logo.png" /> -->
        </div>
		<!-- 欢迎用户的文字 -->
		<div id="Head_1_UserWelcome">
			<img border="0" width="13" height="14" src="${pageContext.request.contextPath }/sys/style/images/user.gif" /> 
			您好，<span style="color:red;font-size:15px;">${u.username}</span><b>管理员</b>
		</div>
		<!-- 一些链接按钮 -->
		<div id="Head_1_FunctionButton">
			...
			<a target="main" href="${pageContext.request.contextPath }/esclogin">
